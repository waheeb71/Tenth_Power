...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    {
      id: '6',
      title: 'مجمع سكني راقي القوة العاشرة',
    ...
    },
    {
      ...
      category: 'glass',
      description: 'حلول زجاجية مخصصة ومبتكرة من شركة القوة العاشرة - تصميم وتنفيذ مشاريع زجاج فريدة تلبي احتياجات العملاء الخاصة في الرياض',
